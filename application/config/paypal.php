 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'sitsdeveloper-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '1396502808' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'ARocuuQ5.-EzWLXy-YgAG6LNdtU8Av0bRMdXrLNeEFtTU7rwwnANt5y5' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = $config['Sandbox'] ? 'sitsdeveloper@gmail.com' : 'PRODUCTION_DEV_EMAIL_GOES_HERE';
...
$config['returnurl'] = site_url("/checkout/success/");

$config['returnurl'] = site_url("/checkout/donation_success/");

$config['cancelurl2'] = site_url("/profile/");

$config['cancelurl'] = site_url("/store/");

$config['notifyurl'] = site_url("/process/");

$config['LOGOIMG'] = "http://www.dumpflings.com/template/asian/resources/img/logo-red.png";
