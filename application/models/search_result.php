                    ...
                    <div class="col-sm-4">
                        <form method="post" action="/search_result" class="frm-search form-horizontal">
                            ...
                            <div >
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="checkbox-inline col-sm-3">
												<?php  echo form_radio($match['lifestyle']) . '<br />' . $match['lifestyle']['value'];?>
                                            </label>
                                            <label class="checkbox-inline col-sm-3">
                                                <?php echo form_radio($match['lifestyle1']) . '<br />' . $match['lifestyle1']['value'];?>
                                            </label>    
                                            <label class="checkbox-inline col-sm-3">
                                                <?php echo form_radio($match['lifestyle2']) . '<br />' . $match['lifestyle2']['value'];?>
                                            </label>
										...
										?>
											...
											<div class="form-group">
                                            <label class="checkbox-inline col-sm-3" >
                                                <input name="body_type" <?php if(isset($btvalue['selected'])){ echo "checked=\"checked\"";}?> value="<?php echo $btvalue['value']; ?>" type="radio"><br /><?php echo $btvalue['options']; ?>
                                            </label>											
											<?php
											} else {
											?>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-10" for="amount">Overall rating</label>
                                    <div class="col-sm-10 col-sm-offset-1">
                                        <input class="single-filter" type="text" name="overall" value="0;100" />
                                    </div>
                                </div>
                                <div class="form-group">
							...
							?>								
                                <div class="col-sm-6">
                                    <a href="#demo" class="pull-right advanced-search-btn">Advance Search </a>
                                </div>
							<?php
							}
							?>
						...
						foreach($found_users as $fid=>$fvalue){
										...
										<div class="col-sm-6">
											<div class="member-box content-box-border">
												<div class="member-avatar pull-left">
													<a href="/profile/user/<?php echo $fid;?>" ><img src="/resources/img/gallery_1.png" alt=""></a>
												</div>
												...
												<p class="member-action">
													...
													<a href="#modal-heart" title="Send Heart" data-toggle="modal"><i class="fa fa-heart"></i></a>
													<a href="#modal-like" title="Like" data-toggle="modal"><i class="fa fa-thumbs-up"></i></a>
													<a href="#modal-warning" title="Warning" data-toggle="modal"><i class="fa fa-exclamation"></i></a>
													<a href="#modal-fav" title="Add to Favourite" data-toggle="modal"><i class="fa fa-plus"></i></a>
												</p>
											</div>	
										</div>
										<?php
								...
								?>
											<div class="col-sm-6">
												<div class="member-box content-box-border">
													<div class="member-avatar pull-left">
														<a href="#modal-login" data-toggle="modal"><img src="/resources/img/gallery_1.png" alt=""></a>
													</div>
