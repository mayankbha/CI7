        ...
        <section class="container">
            <div class="row">
                <ol class="breadcrumb">
					...
					<li class="active"><span> Spam </span></li>
                </ol>
            </div>
                    ...
                    <div class="mail-ct content-box-border">
                        <div class="mail-tbl">
                            <table class="table table-hover">
                                <tbody>
                                	<form id="delete_mails" action="/mail/spam" method="post">
                                    <?php
									//print_r($inbox);die;
                                    foreach($inbox as $ikey=>$ivalue){
                                        ...
                                        ?>">
                                            ...
                                            <td width="55%"><a href="/mail/view_spam_email/<?php echo $ivalue['id'].'/'.$ivalue['from_user_id'].'/'.$ivalue['to_user_id'].'/'.$ivalue['subject'];?>"><div><?php echo $ivalue['subject'];?></div></a></td>
                                            <td width="15%"><a href="/mail/view_spam_email/<?php echo $ivalue['id'].'/'.$ivalue['from_user_id'].'/'.$ivalue['to_user_id'].'/'.$ivalue['subject'];?>"><div><?php echo $timeformat; ?></div></a></td>
