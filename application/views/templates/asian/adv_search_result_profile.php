<div class="content-box">
    <section class="container"> 
       ...
       <div align="right" class="txt-green"><a href="javascript:history.go(-1)"> << Back to Advance Search</a></div><br />


        <?php /*?><div class="section-title bg-red txt-upper"> <?php echo $this->lang->line('search_title');?> </div>
        <?php
