        ...
        <section class="container">
            <div class="row">
                <ol class="breadcrumb">
					...
					<li class="active"><span>Favorites</span></li>
                </ol>
            </div>
						...
						?>
                            ...
                            <tbody>
								...
								foreach($inbox as $ikey=>$ivalue){
									...
									?>
									<tr class="mail-item mail-item-unread">
										...
										<?php /*?><td width="55%"><a href="/mail/view_email/<?php echo $ivalue['id'];?>"><div><?php echo $ivalue['subject'];?></div></a></td>
										<td width="15%"><a href="/mail/view_email/<?php echo $ivalue['id'];?>"><div><?php echo $timeformat; ?></div></a></td><?php */?>
                                        
                                        <td width="55%"><a href="/mail/view_favorite_email/<?php echo $ivalue['id'].'/'.$ivalue['from_user_id'].'/'.$ivalue['to_user_id'].'/'.$ivalue['subject'];?>"><div><?php echo $ivalue['subject'];?></div></a></td>
										<td width="15%"><a href="/mail/view_favorite_email/<?php echo $ivalue['id'].'/'.$ivalue['from_user_id'].'/'.$ivalue['to_user_id'].'/'.$ivalue['subject'];?>"><div><?php echo $timeformat; ?></div></a></td>
									</tr>									
									<?php
								}
								?>
