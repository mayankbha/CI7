    <div class="content-box">
        ...
        <section class="container">
            ...
            <div class="mail-wrap row">
                ...
                <div class="col-sm-9 reload_cont">
                    <div class="mail-action page-title">
                        <div class="row">
                            <div class="col-sm-6 col-xs-6">  
                                <a href="/mail" class="btn btn-default btn-lg" title="Back to Maillist"><i class="fa fa-angle-double-left"></i></a>
                            </div>
                            <div class="col-sm-6 col-xs-6">
                                <div class="btn-group btn-group-lg pull-right">
                                  <a href="<?php echo base_url();?>/mail/previous_mail/<?php echo $mail_id; ?>" class="btn btn-default"><i class="fa fa-angle-left"></i></a>
                                  <a href="<?php echo base_url();?>/mail/next_mail/<?php echo $mail_id; ?>" class="btn btn-default"><i class="fa fa-angle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php foreach($mail_data as $mail_data)
					{
						...
						<? // print_r($mail_data['block_user_id']);?>
							<?php if($mail_data['from_user_id'] == $this->session->userdata['user_id']){?>
									<div class="mail-ct-action btn-group">
                                    	<?php if($mail_data['block_user_id'] != $mail_data['from_user_id'])
										{	
											?>
									...
									<div class="mail-ct-action btn-group">
										<?php if($mail_data['block_user_id'] != $mail_data['from_user_id'])
										{
                                        	...
                                        	<? 
                                       		...
                                       		<a href="" class="btn btn-default" title="You can not reply to block user"><i class="fa fa-ban"></i> </a>
                                            <div class="btn-group">
                                                <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
                                                <div class="dropdown-menu" id="mail-ct-action">
                                                    <li><a href="<?php echo base_url('/mail/move_to_spam').'/'.$mail_data['id']; ?>"><i class="fa fa-exclamation"></i> Report Spam</a></li>
                                                   <?php /*?> <li><a href="<?php echo base_url('/mail/unblock_user').'/'.$mail_data['from_user_id']?>"><i class="fa fa-ban"></i> Unblock User</a></li><?php */?>
                                                    <li><a id="<?php echo $mail_data['from_user_id'];?>" class="user_unblock" ><i class="fa fa-ban"></i> Unblock User</a></li>
                                                    <li><a class="" href="<?php echo base_url('/mail/delete_inbox_msg').'/'.$mail_data['id']; ?>"  onclick="return confirm('Are You sure Want to delete?');"><i class="fa fa-trash-o"></i> Delete Mail</a></li>
                    ...
                    <!--div class="mail-ct content-box-border">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Content</label>
                                <div class="col-sm-10">
                                    <textarea cols="80" id="editor1" name="editor1" rows="10" class="editor-ck form-control">
                    ...
                    <div class="mail-ct content-box-border">
                        <div class="mail-ct-action btn-group">
                            ...
                            <div class="btn-group">
                                <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></a>
                                <div class="dropdown-menu" id="mail-ct-action">
                                    <li><a href="#"><i class="fa fa-exclamation"></i> Report Spam</a></li>
                        ...
                        <ul class="media-list discuss-list">
                            <li class="media">
                                <a class="pull-left avatar-md" href="#" title="<strong>Education:</strong> 12/12<br>
                                <strong>Have children:</strong> <?php echo $boolean_to_text[$sender_data['have_children']];?><br>
                                <strong>Drink:</strong> <?php echo $boolean_to_text[$sender_data['drink']];?><br>
                                <strong>Smoke:</strong> <?php echo $boolean_to_text[$sender_data['smoke']];?><br><br>
                                ...
                                <div class="media-body">
                                    <h4 class="media-heading txt-red"><?php echo $mail_data['subject'];?></h4>
                                    <p><strong class="txt-orange"><?php echo $sender_data['first_name']. ' ' . $sender_data['last_name'];?></strong> at <small><?php echo $mail_time.' ' .$mail_date;?></small><br>
                                    <?php echo $mail_data['content'];?></p>
