<script>$(function() {<?php $currentYear=date("Y");$endyear=$currentYear-17;$startyear=$currentYear-100;?>$( "#datepicker" ).datepicker(	{					buttonImage: '/templates/',					buttonText: null,					buttonImageOnly: true,					changeYear:true,					yearRange: "<?php echo $startyear; ?>:<?php echo $endyear;?>",					dateFormat: "dd/mm/yy",	});});</script>
  ...
  <center>
    <div class="reg_container">
      ...
      <div class="reg_innerContainer2">
        ...
        <div class="reg_left1">
          <?php						echo form_open("./register/step_2", array('id'=>'registration_form'));?>
          <table class="reg_form2" style="padding-left:30px;width:95%;">
            ...
            <tr>
              <td>Hair Color</td>
              <td>&#160;&#160;&#160;</td>
              <td><?php echo form_dropdown('hair_color', $hair_color['options'], $hair_color['value'], $hair_color['form_options']);?> </td>
            </tr>
            <tr>
              <td>Eye Color</td>
              <td>&#160;&#160;&#160;</td>
              <td><?php echo form_dropdown('eye_color', $eye_color['options'], $eye_color['value'], $eye_color['form_options']);?> </td>
            </tr>
            <tr>
              <td>Height</td>
              <td>&#160;&#160;&#160;</td>
            ...
            <tr>
              <td>Body Type</td>
              <td>&#160;&#160;&#160;</td>
              <td><?php echo form_dropdown('body_type', $body_type['options'], $body_type['value'], $body_type['form_options']);?> </td>
            </tr>
            <tr>
        ...
        <div class="reg_right1">
          <table class="reg_form2" style="padding-left:30px;width:95%;">
            ...
            <tr>
              <td colspan="3"><?php 								form_error('relationship_your_looking_for');								//print_r($relationship_your_looking_for);								foreach($relationship_your_looking_for as $rylf){									//print_r($rylf);									echo '&#160;'.form_checkbox($rylf).'&#160;'.str_replace('-', ' ', $rylf['value']).' &#160;&#160;';								}							?>
              </td>
            </tr>
          </table>
        </div>
            ...
            <div style="float:left;width:440px;text-align:left;">
              <table class="reg_form3" style="padding-left:30px;width:90%;">
                ...
                <tr>
                  <td>Nationality:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('nationality', $nationality['options'], $nationality['value'], $nationality['form_options']);?> </td>
                </tr>
                <tr>
                  <td>Education:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('education', $education['options'], $education['value'], $education['form_options']);?> </td>
                </tr>
                <tr>
                  <td>English language ability:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('english_ability', $english_ability['options'], $english_ability['value'], $english_ability['form_options']);?> </td>
                </tr>
                <tr>
                  <td>Religion:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('religion', $religion['options'], $religion['value'], $religion['form_options']);?> </td>
                </tr>
                <tr>
                  <td>Chinese sign:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('chinese_sign', $chinese_sign['options'], $chinese_sign['value'], $chinese_sign['form_options']);?> </td>
                </tr>
                <tr>
                  <td>Star sign:</td>
                  <td>&#160;&#160;&#160;</td>
                  <td><?php echo form_dropdown('star_sign', $star_sign['options'], $star_sign['value'], $star_sign['form_options']);?> </td>
                </tr>
              </table>
            </div>
                ...
                <tr>
                  <td colspan="3"><div style="float:right;width:400px;">
                      <table class="reg_form2" style="padding-left:30px;width:80%;">
                        ...
                        <tr>
                          <td colspan="3"><?php echo form_error('profile_head') . form_input($profile_head); ?> </td>
                        </tr>
                        <tr>
                          <td>A little about yourself:</td>
                          <td>&#160;&#160;&#160;</td>
                          <td></td>
                        </tr>
                        <tr>
                          <td colspan="3"><?php echo form_error('about_yourself') . form_input($about_yourself); ?> </td>
                        </tr>
                        <tr>
                          <td>What you're looking for in a partner:</td>
                          <td>&#160;&#160;&#160;</td>
                          <td></td>
                        </tr>
                        <tr>
                          <td colspan="3"><?php echo form_error('looking_for_in_partner') . form_textarea($looking_for_in_partner); ?> </td>
                        </tr>
                      </table>
                    </div></td>
                </tr>
