...
<div id="center-contents">
    <div class="page-header clearfix">
        <h3 class="pull-left"><?php echo isset($action) ? $action : '' ?> Forum Group</h3>
    </div>
    <div class="tabular_cont">
        ...
        ?>
        <form action="<?php echo base_url('admins/forum_groups/add/' . $id) ?>" id="form_sample_1" class="form-horizontal" method="post" role="form">
